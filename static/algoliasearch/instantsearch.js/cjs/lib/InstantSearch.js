...
function (_EventEmitter) {
  ...
  function InstantSearch(options) {
    ...
    process.env.NODE_ENV === 'development' ? (0, _utils.warning)(Boolean(insightsClient) || !(0, _detectInsightsClient.default)(), withUsage("InstantSearch detected the Insights client in the global scope.\nTo connect InstantSearch to the Insights client, make sure to specify the `insightsClient` option:\n\nconst search = instantsearch({\n  /* ... */\n  insightsClient: window.aa,\n});")) : void 0;
    ...
    if (routing) {
      ...
      _this.EXPERIMENTAL_use((0, _createRouterMiddleware.createRouterMiddleware)(routerOptions));
    }
